class CookieService {
  private readonly HIDE_NOTIFICATION = 'hideNotification';
  ...
  public set hideNotification(value: boolean) {
    this.set(this.HIDE_NOTIFICATION, value ? '1' : '0');
  }

  public get hideNotification(): boolean {
    return this.get(this.HIDE_NOTIFICATION) === '1';
  }
}
